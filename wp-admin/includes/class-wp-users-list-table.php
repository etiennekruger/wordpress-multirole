...
?>
	<div class="alignleft actions">
		<label class="screen-reader-text" for="new_role"><?php _e( 'Add role to&hellip;' ) ?></label>
		<select name="new_role" id="new_role">
			<option value=''><?php _e( 'Add role to&hellip;' ) ?></option>
			<?php wp_dropdown_roles(); ?>
		</select>
		<?php submit_button( __( 'Add' ), 'secondary', 'changeit', false ); ?>
	</div>
	<div class="alignleft actions">
